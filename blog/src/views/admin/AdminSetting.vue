  ...
  <div class="setting-page">
    ...
    <div class="setting-content">
      ...
      >
        ...
        <!-- 网站标题 -->
        <el-form-item label="网站标题" prop="siteTitle" required>
          <el-input v-model="form.siteTitle" placeholder="请输入网站标题" />
        </el-form-item>

        <!-- 页脚 -->
        <el-form-item label="页脚" prop="footer" required>
          <el-input v-model="form.footer" placeholder="请输入页脚信息" />
        </el-form-item>
...
const form = reactive({
  siteName: 'Sara',
  siteTitle: 'POETIZE',
  footer: '云想衣裳花想容，更多资源bygoukai.com',
  status: true,
  backgroundImage: '',
  avatar: '',
  author: 'Luojun',
